# ==========================================
# 📂 檔案名稱： API_2026.py (新版 API 專屬主程式)
# 💡 更新內容： 綁定全新 API 專屬表單，作為純淨數據庫的展示大腦
# ==========================================
...
# 網頁基本設定 & 響應式 CSS 
# ==========================================
st.set_page_config(page_title="2026 戰略指揮 (API版)", layout="wide", initial_sidebar_state="expanded")
...
# 🌟 核心快取大腦 
# ==========================================
@st.cache_data(ttl=3600, show_spinner="連線至 API 專屬大數據庫...")
...
if user_email and "google_key" in st.secrets:
    ...
    except Exception as e: st.sidebar.error("❌ 連線失敗或找不到『權限管理』分頁。")
