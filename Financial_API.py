...
# 💡 更新內容： 新增 Slider 拉動自動重新運算機制，無需再手動按執行鍵！
# ==========================================
...
# 🌟 初始化或記錄目前的推演月份
if 'last_simulated_month' not in st.session_state:
    st.session_state['last_simulated_month'] = simulated_month

# 🌟 核心：檢查是否需要自動更新戰情分析
auto_run_trigger = False
if st.session_state['last_simulated_month'] != simulated_month:
